...
const FifthQuestion: React.FC<IProps> = ({
  currentStep,
  control,
  diaryQuestions,
}) => {
  ...
  return (
    <div className="">
      ...
      <div className="flex space-x-6 mt-20 justify-center">
        <Controller
          name="nameOfTheSleepingPill"
          control={control}
          render={({ field: { onChange, value } }) => {
            return (
              <div className="flex">
                <input
                  className="w-52 text-xl text-left border-b border-gray-600 outline-none"
                  type="text"
                  maxLength={30}
            ...
            return (
              <div className="flex">
                <input
                  ...
                  value={value}
                />
                <p className="mt-1 font-thin">&nbsp; mg</p>
              </div>
            );
          }}
        />
